<?php
/**
 * includes/body-start.php — Opening <body> with loader overlay, background blobs, app container & nav
 * Include này mở thẻ <body>, <div class="app-container"> nhưng KHÔNG đóng chúng.
 * Thẻ đóng nằm trong includes/footer.php
 */
?>
<body>
    <!-- Loading Overlay -->
